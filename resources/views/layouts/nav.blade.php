<nav id="sidebar" class="sidebar">
    <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand" href="#">
            ...
            <span class="align-middle me-3">Digi</span>
        </a>
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a href="{{ route('invitation') }}" class="sidebar-link collapsed">
                    <i class="align-middle" data-feather="users"></i> <span class="align-middle">Undangan</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a href="{{ route('monitoring') }}" class="sidebar-link collapsed">
